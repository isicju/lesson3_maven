...
public class HomeworkHttpServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        context.setHandler(HomeworkHttpServer::handleRequest);
        server.start();
    }
    ...
    private static byte[] getApiData() {
        return (new Gson().toJson(cityApi.getCities())).getBytes(StandardCharsets.UTF_8);
    }
